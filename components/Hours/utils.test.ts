...
describe("nextEndTime", () => {
  ...
  const cases: [[string, string], Date, [Date, NextType] | []][] = [
    [
      ...
      [new Date(`${baseDate} 5:00`), Next.START],
    ],
    [
      ["5:00", "8:00"],
      new Date(`${baseDate} 5:00`),
      [new Date(`${baseDate} 8:00`), Next.END],
    ],
...
describe("calculateHoursWithEndTime", () => {
  const cases: [
    ...
    [
      ...
      [
        ["7:00am a 9:00am", new Date(2021, 0, 1, 7, 0, 0, 0), Next.START],
        ["11:30am a 2:00pm"],
        ["5:30pm a 7:00pm"],
      ],
    ],
    [
      ...
      [
        ["7:00am a 9:00am"],
        ["11:30am a 2:00pm", new Date(2021, 0, 1, 11, 30, 0, 0), Next.START],
        ["5:30pm a 7:00pm"],
      ],
    ],
    [
      ...
      [
        ["7:00am a 9:00am"],
        ["11:30am a 2:00pm", new Date(2021, 0, 1, 14, 0, 0, 0), Next.END],
        ["5:30pm a 7:00pm"],
      ],
    ],
    [
    ...
    [
      ...
      [["6:00am a 5:00am", new Date(2021, 0, 2, 5, 0, 0, 0), Next.END]],
    ],
  ];
